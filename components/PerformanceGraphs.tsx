...
export default function PerformanceGraphs({ userProgress }: PerformanceGraphsProps) {
  ...
  const allTopicsByDomain: { [domain: string]: string[] } = {
    '1.0 General Security Concepts': [
      ...
      'Confidentiality', 'Integrity', 'Availability', 'CIA Triad', 'Non-repudiation',
      'Authentication', 'Authorization', 'Accounting', 'AAA', 'Authenticating people', 'Authenticating systems', 'Authorization models',
      ...
      'Physical security', 'Bollards', 'Access control vestibule', 'Fencing', 'Video surveillance', 'Security guard', 'Access badge',
      'Lighting', 'Sensors', 'Infrared', 'Pressure', 'Microwave', 'Ultrasonic',
      ...
      'Public key infrastructure (PKI)', 'Public key', 'Private key', 'Key escrow', 'Encryption', 'Full-disk', 'Partition', 'File',
      ...
      'Obfuscation', 'Steganography', 'Tokenization', 'Data masking', 'Hashing', 'Salting', 'Digital signatures', 'Key stretching',
      'Blockchain', 'Open public ledger', 'Certificates', 'Certificate authorities', 'Certificate revocation lists (CRLs)',
