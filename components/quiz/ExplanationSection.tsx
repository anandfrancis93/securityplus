  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(20px, 3vw, 32px)' }}>
      ...
      >
        ...
        >
          Core Intent (What This Question Tests)
        </h3>
        <p
          style={{
            color: '#e5e5e5',
        ...
        >
          {question.coreIntent || `This question tests your understanding of ${question.topics?.join(', ')}. It focuses on ${question.difficulty === 'easy' ? 'fundamental concepts' : question.difficulty === 'medium' ? 'practical application and differentiation' : 'complex scenario analysis and integration'} within the context of ${question.topics?.[0] || 'cybersecurity'}.`}
        </p>
      </div>
      ...
      >
        ...
        >
          {question.context ? (
            ...
            <>
              <p style={{ marginTop: 0 }}>
                <strong style={{ color: '#f59e0b' }}>Why It Matters:</strong>
              </p>
              <p style={{ marginBottom: 0 }}>
                {question.explanation || `Understanding ${question.topics?.[0] || 'this topic'} is essential for ${question.difficulty === 'easy' ? 'building foundational knowledge' : question.difficulty === 'medium' ? 'practical security implementation' : 'complex security architecture and decision-making'} in real-world cybersecurity scenarios. This concept is commonly tested on the Security+ exam and frequently applied in professional security roles.`}
              </p>
            </>
          )}
        </div>
