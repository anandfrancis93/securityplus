  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8 overflow-x-hidden">
          {/* Total */}
          <div className="bg-gray-800 rounded-lg p-3 border border-gray-700 relative">
            ...
            {openTooltip === 'total' && (
              <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-gray-900 border border-gray-600 rounded-lg p-3 shadow-xl">
